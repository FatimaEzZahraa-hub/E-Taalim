        ...
        <div class="col-md-3 conversation-list">
            ...
            <div class="conversations">
                ...
                <div class="conversation-item @if($activeConversation && $activeConversation->id == $conversation->id) active @endif" 
                     onclick="window.location.href='{{ route("admin.messaging.conversation", $conversation->id) }}'">
                    <div class="avatar">
                        @if($conversation->type == 'group')
                        <div class="group-avatar">{{ substr($conversation->name, 0, 1) }}</div>
                        @else
                        <div class="user-avatar">{{ substr($conversation->participant->nom, 0, 1) }}</div>
                        @endif
                    </div>
                    <div class="conversation-info">
                        ...
                        <div class="last-message">{{ $conversation->lastMessage ? Str::limit($conversation->lastMessage->contenu, 30) : 'Aucun message' }}</div>
                    </div>
                    <div class="conversation-meta">
                        <div class="time">{{ $conversation->lastMessage ? $conversation->lastMessage->created_at->format('H:i') : '' }}</div>
        ...
        <div class="col-md-9 chat-area">
            ...
            <div class="chat-header">
                <div class="chat-title">
                    ...
                    @else
                        {{ $activeConversation->participant->nom }} {{ $activeConversation->participant->prenom }}
                    @endif
                </div>
