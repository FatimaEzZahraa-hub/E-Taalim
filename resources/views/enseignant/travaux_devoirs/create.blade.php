...
@section('title', 'Ajouter un Travail/Devoir')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Ajouter un Travail/Devoir</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="POST" action="{{ route('enseignant.travaux_devoirs.store', $cours->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input id="date_limite" type="date" class="form-control @error('date_limite') is-invalid @enderror" name="date_limite" value="{{ old('date_limite') }}" required>
                    @error('date_limite')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
